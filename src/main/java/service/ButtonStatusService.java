...
public class ButtonStatusService {

	public static void enableButton() {
		MinerCheckApp.button_5.setEnabled(true);
		MinerCheckApp.btnNewButton.setEnabled(true);
		MinerCheckApp.button_plus.setEnabled(true);
		MinerCheckApp.button_minus.setEnabled(true);
...
//	    MinerCheckApp.button_setting.setEnabled(true);
	    ...
	    MinerCheckApp.button_3.setEnabled(true);
//	    MinerCheckApp.button_4.setEnabled(true);
//	    MinerCheckApp.btnCheckButton.setEnabled(true);
//	    MinerCheckApp.btnCheckButton_4.setEnabled(true);
//	    MinerCheckApp.btnCheckButton_5.setEnabled(true);
...
//	    MinerCheckApp.btnCheckButton_6.setEnabled(true);
	...
	public static void disableButton() {
		MinerCheckApp.button_5.setEnabled(false);
		MinerCheckApp.btnNewButton.setEnabled(false);
		MinerCheckApp.button_plus.setEnabled(false);
		MinerCheckApp.button_minus.setEnabled(false);
...
//	    MinerCheckApp.button_setting.setEnabled(false);
	    ...
	    MinerCheckApp.button_3.setEnabled(false);
//	    MinerCheckApp.button_4.setEnabled(false);
//	    MinerCheckApp.btnCheckButton.setEnabled(false);
//	    MinerCheckApp.btnCheckButton_4.setEnabled(false);
//	    MinerCheckApp.btnCheckButton_5.setEnabled(false);
